...
(**
    Functions for parsing sqlite programs into a CST.

    Generated by ocaml-tree-sitter.
*)

(** Parse a sqlite program from a string into a typed OCaml CST.
...
val string :
  ...
  (CST.sql_stmt_list, CST.extra) Tree_sitter_run.Parsing_result.t

(** Parse a sqlite program from a file into a typed OCaml CST.
